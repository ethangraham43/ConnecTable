...
function CardItem({restaurant}) {
    ...
    return (
        ...
        <img src={restaurant.photoUrl} className="card-photo" />
        </NavLink>
        <NavLink className="restaurant-card-navlink" to={`/restaurants/${restaurant.id}`}>

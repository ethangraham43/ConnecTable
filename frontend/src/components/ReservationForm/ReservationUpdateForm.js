...
//                                 <p>{reservationDate(reservation.date)}</p>
//                             </li>
//                             <li className='update-description-li'>
...
//                                 <p>{reservationTime(reservation.time)}</p>
//                             </li>
//                             <li className='update-description-li'>
...
//                 <label>
//                     Date:
//                     <input type="date" className="update-date-selector" min={new Date().toISOString().split('T')[0]}  value={date} onChange={(e) => setDate(e.target.value)}></input>
//                 </label>
//                 <label>
//                     Time:
...
//                 <label>
//                     Party Size:
//                     <select className='update-party-size-selector' value={partySize} onChange={(e) => setPartySize(e.target.value)}>
...
// import { useSelector, useDispatch } from 'react-redux';
// import { updateReservation, fetchReservation } from '../../store/reservations';
// import { useState, useEffect } from 'react';
...
//             try {
//                 const res = await dispatch(fetchReservation(id));
//                 setReservation(res);
//                 const rest = await dispatch(fetchRestaurant(res.restaurantId));
//                 setRestaurant(rest);
...
//                 userId: reservation.userId
//             }));
//             // navigate to the user's reservation history page
//             history.replace({ pathname: `/users/${reservation.userId}`});
//         } catch (err) {
//             setError(err);
//         }
...
//                         <label>
//                             Party Size:
//                             <input type="number" value={partySize} onChange={e => setPartySize(e.target.value)} min="1" max="20" />
//                         </label>
//                         <br />
//                         <label>
//                             Date:
                ...
                <div className="update-card-description">
                    ...
                    <div className='description-ul-div'>
                        <ul className='description-ul'>
                            ...
                            <li className='update-description-li'>
                                <svg className="hours-logo" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" focusable="false">
                                    <path d="M17,5 L19,5 C20.1045695,5 21,5.8954305 21,7 L21,19 C21,20.1045695 20.1045695,21 19,21 L5,21 C3.8954305,21 3,20.1045695 3,19 L3,7 C3,5.8954305 3.8954305,5 5,5 L7,5 L7,4 C7,3.44771525 7.44771525,3 8,3 C8.55228475,3 9,3.44771525 9,4 L9,5 L15,5 L15,4 C15,3.44771525 15.4477153,3 16,3 C16.5522847,3 17,3.44771525 17,4 L17,5 L17,5 Z M12,2 C9.23857625,2 7,4.23857625 7,7 C7,9.76142375 9.23857625,12 12,12 C14.7614237,12 17,9.76142375 17,7 C17,4.23857625 14.7614237,2 12,2 L12,2 Z"></path>
                                    </svg>
